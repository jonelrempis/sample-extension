...
function extendQuasarConf (conf) {
  ...
  conf.boot.push('~quasar-app-extension-sample-extension/src/boot/register.js')

  // make sure boot file get transpiled
  conf.build.transpileDependencies.push(/quasar-app-extension-sample-extension[\\/]src/)
